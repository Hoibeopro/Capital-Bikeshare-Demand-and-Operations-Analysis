...
```
.
├── F2_MA_HOI_Project3 (3) (1).ipynb      # Tầng dài hạn: dự báo theo tháng (LinearRegression + Seasonal Index)
├── F1_MAHOI_Offcal_Projec (1).ipynb      # Tầng ngắn hạn: dự báo theo giờ (XGBoost Ratio-based)
├── CapitalBikeshare_v3_Final (1).pdf     # Báo cáo trình bày kết quả cho stakeholder (28 slide)
...
```bash
git clone https://github.com/Hoibeopro/Capital-Bikeshare-Demand-and-Operations-Analysis.git
cd Capital-Bikeshare-Demand-and-Operations-Analysis
pip install pandas numpy scikit-learn xgboost statsmodels prophet holidays matplotlib seaborn joblib
jupyter notebook "F2_MA_HOI_Project3 (3) (1).ipynb"   # Tầng dài hạn — dự báo theo tháng
jupyter notebook "F1_MAHOI_Offcal_Projec (1).ipynb"   # Tầng ngắn hạn — dự báo theo giờ
```

> ⚠️ F2 cần tự tải 107 file ZIP dữ liệu gốc từ [Capital Bikeshare System Data](https://capitalbikeshare.com/system-data) (link tải được cấu hình ngay trong notebook). F1 dùng trực tiếp [UCI Bike Sharing Dataset](https://archive.ics.uci.edu/dataset/275/bike+sharing+dataset), không cần tải thêm.
